    ...
    <div class="container px-0" style="min-height: 100vh;">
        ...
        <div class="d-flex justify-content-center  mb-3 w-100 h-100 px-2 px-md-0" style="min-height: 85vh;">
            <div class="col-12 col-md-3 align-self-center card text-dark mb-3 rounded-0 shadow h-100 border-0" style="min-width:30vw;">
                <div class="card-header bg-white text-center text-dark fs-3 border-0">
                    <img class="me-2" height="120" src="res/images/icon.png" alt="">
                    <span class="d-block display-6 fw-bold">B-Care</span>
                </div>
                <div class="card-body bg-white px-4">
                    <form action="#" method="POST">
                        <div class="mb-4 fs-3">
                            <input type="text" class="form-control fs-4 bg-light border-0 border-bottom border-2 rounded-0 border-dark" id="email" placeholder="Email">
                        </div>
                        <div class="mb-4 fs-3">
                        ...
                        <button class="btn btn-outline-dark rounded-0 w-100 fs-3 align-self-end mb-4" id="button-login">Log In</button>
